    ...
    [
      _c(
        "v-navigation-drawer",
        {
          ...
          scopedSlots: _vm._u(
            [
              _vm.auth.profile.profile_complete
                ? {
                    key: "prepend",
                    fn: function() {
                      return [
                              ...
                              [
                                _c("avatar", {
                                  attrs: {
                                    ...
                                    color: "primary",
                                    size: "70",
                                    text: _vm.auth.profile.initials
                                  }
                                })
                              ],
                              1
                            ...
                            _c(
                              ...
                              [
                                _c("v-list-item-title", {
                                  domProps: {
                                    innerHTML: _vm._s(_vm.auth.profile.fullname)
                                  }
                                }),
                                _vm._v(" "),
