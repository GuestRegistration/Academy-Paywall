...
/* harmony import */ var _Components_CourseCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../Components/CourseCard */ "./resources/js/Domain/Course/Components/CourseCard.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "CourseList",
  components: {
    CourseCard: _Components_CourseCard__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
    ...
    [
      _c(
        ...
        [
          _c(
            "inertia-link",
            { attrs: { href: _vm.route("course.create") } },
            [
              _c(
                "v-btn",
                { attrs: { color: "primary" } },
                [_c("v-icon", [_vm._v("add")]), _vm._v(" new course")],
                1
              )
            ],
            1
      ...
      !_vm.courses.total
        ? _c(
            ...
            [
              _c("v-col", { attrs: { md: "6" } }, [
                _c("div", { staticClass: "text-center text-muted p-5" }, [
                  _c("h4", [_vm._v("No course available yet")])
                ])
              ])
            ],
            1
