...
/* harmony import */ var _Components_CoursesQuickEnroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/CoursesQuickEnroll */ "./resources/js/Domain/Account/Components/CoursesQuickEnroll.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    CoursesQuickEnroll: _Components_CoursesQuickEnroll__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c("v-spacer"),
          _vm._v(" "),
          _vm.authenticated && _vm.auth.account && !_vm.isMyAccount(_vm.account)
            ? _c(
                "inertia-link",
                {
                  staticClass: "prevent-default mx-1",
                  attrs: {
                    href: _vm.auth.account.username
                      ...
                      [
                        _vm.account.bio
                          ? [
                              ...
                              _vm._v(" "),
                              _c("h4", [
                                _vm._v("About " + _vm._s(_vm.account.name))
                              ]),
                              _vm._v(" "),
                              _c("v-divider"),
                              _vm._v(
