...
/* harmony import */ var _Components_CourseDelete__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../Components/CourseDelete */ "./resources/js/Domain/Course/Components/CourseDelete.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    CourseDelete: _Components_CourseDelete__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
            ...
            [
              _vm._l(_vm.data, function(course) {
                return _c(
                  ...
                  [
                    _c("course-card", {
                      attrs: { account: _vm.account, course: course },
                      scopedSlots: _vm._u(
                        [
                          {
                            key: "options",
